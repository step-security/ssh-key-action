...
/** default known_hosts */
/** read more about provided github host key here: https://github.blog/news-insights/company-news/we-updated-our-rsa-ssh-host-key/ */
const KNOWN_HOSTS = [
...
/**
 * validate subscription function
 * @returns void
 */
async function validateSubscription(): Promise<void> {
    const API_URL = `https://subscription.free.beeceptor.com/subscriptions/plan`;
